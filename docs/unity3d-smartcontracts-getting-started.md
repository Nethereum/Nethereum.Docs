#Unity3d smartcontracts 

In a similar way to the Nethereum smart contracts, Unity3d can use the contract deployment and function message definitions to interact with the blockchain.
